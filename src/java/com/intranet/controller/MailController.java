...
import com.intranet.service.MessageDAOImpl;
...
public class MailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String recievedTime=request.getParameter("recievedTime");
           ...
           Mail m = new Mail(to,from,subject,sentTime,recievedTime);
           MailDAO md=new MailDAOImpl();
           md.create(m);
           
           out.println("hai"+md.read());
           Message msg=new Message(message,md.read());
           MessageDAO msd=new MessageDAOImpl();
          out.println(msd.create(msg));
